<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            <li class="nav-item nav-dropdown {{ active_class(Route::is('admin/memberships'), 'open') }}">
                <a class="nav-link nav-dropdown-toggle {{ active_class(Route::is('admin/memberships*')) }}" href="#">
                    <i class="nav-icon fas fa-rss"></i> @lang('menus.backend.sidebar.memberships')
                </a>

                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link {{ active_class(Route::is('admin/memberships/all')) }}" href="{{ route('admin.memberships.index') }}">
                            @lang('labels.backend.access.memberships.all')
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ active_class(Route::is('admin/memberships/create*')) }}" href="{{ route('admin.memberships.create') }}">
                            @lang('labels.backend.access.memberships.create')
                        </a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link {{ active_class(Route::is('admin/memberships/import*')) }}" href="{{ route('admin.memberships.create') }}">
                            @lang('labels.backend.access.memberships.import')
                        </a>
                    </li>
                </ul>
            </li>
