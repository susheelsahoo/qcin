        ...
        <div class="inner-grp clearfix">
            ...
            <div class="right-side">
                ...
                <div class="descripton mb-30">
                    ...
                    <p style="text-align:justify;">At its inception, NABET began life as the National Accreditation Board for Auditors and Training (NABAT), which was set up in response to the emerging challenges in the conformity assessment arena with the mandate to establish and monitor the training and auditor’s registration process. National Accreditation Board for Auditors and Training (NABAT) started working as registrar for auditors and training courses operating in arena of conformity assessment area such as QMS and EMS.......<a href="#">Read more</a></p>
                    ...
                    <p style="text-align:justify;">National Accreditation Board for Hospitals &amp; Healthcare Providers (NABH) operates accreditation programme for healthcare organisations. The board is structured to cater to much desired needs of the consumers and to set benchmarks for progress of healthcare organizations......<a href="#">Read more</a></p>
                    <h3 style="text-align:justify;">NBQP</h3>
                    <p style="text-align:justify;">National Board for Quality Promotion (NBQP) works on the mission of promoting quality of life of the Citizens of India. The Board organizes events i.e., Quality Conclaves (National/Regional/Virtual) and Quality Month Competitions......<a href="#">Read more</a></p>
                    <div class="left_"></div>
