        ...
        <div class="inner-grp clearfix">
                            ...
                            <div id="collapseone-5" class="collapse" aria-labelledby="headingone" data-parent="#accordionExample">
                                <div class="card-body">
                                    <ul class="avvv" style="padding-left:20px;">
                                        ...
                                        <li class="submenu-xcb "><a href="icc-for-sexual-harassment{{ route('frontend.history') }}">ICC for Sexual Harassment</a></li>
                                        <li class="submenu-xcb "><a href="minutes-of-gb{{ route('frontend.history') }}">Minutes of GB</a></li>
                                        <li class="submenu-xcb "><a href="minutes-of-gc{{ route('frontend.history') }}">Minutes of GC</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
            ...
            <div class="right-side">
                ...
                <div class="descripton mb-30">
                    <p>The various bodies of QCI which makes Governance Structure are:</p>
                    <ul>
                        <li>The Governing Council (GC)</li>
                        <li>The Governing Body (GB)</li>
