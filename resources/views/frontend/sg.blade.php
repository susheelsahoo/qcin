        ...
        <div class="inner-grp clearfix">
            ...
            <div class="right-side">
                ...
                <div class="descripton mb-30">
                    ...
                    <p style="text-align:justify;"><img alt="" class="sg-general" src="{{ url('/img/frontend/homeimages/1610942242.SG.jpg') }}" style="width:400px;height:300px;margin:5px;float:left;border-width:1px;border-style:solid;" /></p>
