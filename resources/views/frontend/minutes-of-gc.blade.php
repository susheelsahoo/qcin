        ...
        <div class="inner-grp clearfix">
            ...
            <div class="right-side">
                ...
                <div class="descripton mb-30">
                    <ul>
                        <li>
                            <h4><a href="#"><span style="margin:0px;background-color:#FFFFFF;">Special meeting of Council</span></a></h4>
                        </li>
                        <li>
                            <h4><a href="#">18th Annual Council Minutes</a></h4>
                        </li>
                        <li>
                            <h4><a href="#">19th Annual Council Minutes</a></h4>
                        </li>
                        <li>
                            <h4><a href="#" target="_blank" rel="noreferrer noopener">20th Annual Council Minutes</a></h4>
                        </li>
                        <li>
                            <h4><a href="#" target="_blank" rel="noreferrer noopener">21st Annual Council Minutes</a></h4>
                        </li>
                        <li><a href="#">22nd Annual Council Minutes</a></li>
                        <li><a href="#">23rd Annual Council Minutes</a></li>
                    </ul>
                    <div class="left_"></div>
