            ...
            <div class="right-side">
                ...
                <div class="descripton mb-30">
                    ...
                    <ul>
                        ...
                        <li style="text-align:justify;"><a href="#" target="_blank" rel="noreferrer noopener">QCI Introductory text</a></li>
                    </ul>
                    ...
                    <p style="text-align:justify;">QCI has launched the Certification Scheme for Remotely Piloted Aircraft Systems (RPAS) duly approved by the Directorate General of Civil Aviation (DGCA), Ministry of Civil Aviation, the regulator for RPAS on 17th September 2020.</p>
                    ...
                    <ul>
                        <li><a href="#" target="_blank" rel="noreferrer noopener"><span>EoI_QCI_CHILD RIGHTS</span></a></li>
                        <li><span><span style="background-color:rgb(255,255,255);"><a href="#" target="_blank" rel="noreferrer noopener">RFP_QCI_CHILD RIGHTS</a></span></span><a href="#" target="_blank" rel="noreferrer noopener"><span style="line-height:108%;">
                    ...
                    <p style="text-align:justify;">ITTO, a Japan-based intergovernmental agency, approached QCI to conduct a pan-India perception survey focused on the furniture industry. The activity involved interaction with government and private associations to understand the current ecosystem for enhancing furniture exports.</p>
                    ...
                    <p style="text-align:justify;">The National Medicinal Plant Board, Ministry of AYUSH granted QCI the CB&amp;S project for the marketing and promotion of the VCSMPP Scheme. Till date we have compiled 40 Package of Practices, conducted over 30 sensitisation workshops and presented the Scheme to the SAARC Agriculture Secretariat of the SAARC for considering its acceptance. </p>
                    <p style="text-align:justify;">The scheme was translated in 12 languages and is available on the QCI website. The 12 languages are Assamese, Bengali, Gujarati, Hindi, Kannada, Malayalam, Marathi, Mizo, Oriya, Punjabi, Tamil, and Telugu.</p>
                    ...
                    <ul>
                        ...
                        <li style="text-align:justify;">In concurrence with the outcome of Standards Conclaves organized in 2014 and 2015, UNFSS and Quality Council of India (QCI) joined hands for setting up the India National Platform on Private Sustainability Standards (PSS).</li>
                        ...
                        <li style="text-align:justify;">QCI represented the Platform at the UNCTAD, T4SD of the ITC, UN, and at the National Stakeholder meetings in China, Brazil, Mexico, South Africa, Philippines showcasing the activities undertaken in the sustainability studies.</li>
                    </ul>
                    ...
                    <ul>
                        <li style="text-align:justify;">GLOBALG.A.P., owner of global standard for the certification of agricultural produce, and QCI entered into a MoU in May 2008. QCI constituted a National Technical Working Group (NTWG) - a mechanism to internalise local practices.</li>
                    ...
                    <ul>
                        ...
                        <li style="text-align:justify;">QCI has signed an MoU with APEDA for funding the Benchmarking proposal of IndGAP with GLOBALG.A.P.</li>
                        ...
                        <li style="text-align:justify;">APEDA has granted QCI (PADD) a project for benchmarking IndGAP to GLOBALG.A.P.</li>
                    ...
                    <ul>
                        ...
                        <li style="text-align:justify;">Spices Board has granted QCI (PADD) a project for implementation of IndGAP for carrying out promotion and marketing of the IndGAP Scheme</li>
                    ...
                    <p style="text-align:justify;">The Food and Agriculture Organisation (FAO) of the UN identified QCI as their technical partner for developing a quality infrastructure on Good Agriculture Practice for all the SAARC member countries. The project was for “Development of Standards and Scheme for Good Agriculture Practice (GAP) Implementation and Certification in countries of SAARC”. The Scheme designed and developed by QCI was accepted and implemented in some select SAARC countries with the assistance of FAO of the UN. The SAARC Agriculture Center (SAC) has taken forward this initiative for improving the food hygiene and safety in the region.</p>
                    ...
                    <p style="text-align:justify;">The SAARC Agriculture Centre approached QCI with a request to conduct SAARC Good Agricultural Practices training for all the SAARC member countries. The SAC aims to engage the Agriculture Ministry of each of the member countries for adaptation or adoption of the SAARC GAP. </p>
                    ...
                    <ul>
                        <li style="text-align:justify;">The Honorable Prime Minister had desired to spread India’s traditional knowledge worldwide with credible systems with specific reference to Yoga that should provide India leadership in assuring quality of Yoga practices across the world. The Ministry of AYUSH in pursuance of the above and in the wake of declaration of International Yoga Day, identified Quality Council of India (QCI) to develop a Scheme for Voluntary Certification of Yoga Professionals recognizing that QCI has expertise in developing such quality frameworks based on international best practices.</li>
                        <li style="text-align:justify;">QCI designed the Scheme for Voluntary certification of Yoga Professional by adopting the principles and requirements laid down in the international standard that was presented to the Ministry of AYUSH and was launched on 22 June 2015.</li>
                        <li style="text-align:justify;">The scheme has been handed over to Ministry of AYUSH after successful grounding by QCI.</li>
                    </ul>
                    ...
                    <p style="text-align:justify;">MoU has been signed with ICRISAT for design and development of certification Scheme on ‘Smart Food’ by Dr. Jacqueline d’Arros Hughes, Director General and Dr. Ravi P. Singh, SG, QCI.</p>
                    <p style="text-align:justify;"><strong>19. United Nations Development Programme (UNDP):</strong></p>
                    <p style="text-align:justify;">The UNDP has approached QCI to help them with the design and development of Scheme for Access and Benefit Sharing as per the National Biodiversity Act 2002.<br />
