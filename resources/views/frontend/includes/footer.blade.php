        ...
        <div class="row">
            <div class="col-md-3 footer-link">
                ...
                <ul>
                    ...
                    <li><a href="tenders{{ route('frontend.history') }}">Tenders</a></li>
                    <li><a href="rti-cell{{ route('frontend.history') }}">RTI</a></li>
                    <li><a href="ethics-cell{{ route('frontend.history') }}">Ethics Cell</a></li>
                    <li><a href="archives{{ route('frontend.history') }}">Archives</a></li>
                    <li><a href="faq{{ route('frontend.history') }}">FAQs</a></li>
            ...
            <div class="col-md-4 footer-link">
                ...
                <ul>
                    <li><a href="nabcb/{{ route('frontend.index') }}" target="_blank" rel="noreferrer noopener">NABCB</a></li>
                    <li><a href="nabet/{{ route('frontend.index') }}" target="_blank" rel="noreferrer noopener">NABET</a></li>
                    <li><a href="https://nabl-india.org/" target="_blank" rel="noreferrer noopener">NABL</a></li>
                    <li><a href="nabh/{{ route('frontend.index') }}" target="_blank" rel="noreferrer noopener">NABH</a></li>
                    <li><a href="nbqp/{{ route('frontend.index') }}" target="_blank" rel="noreferrer noopener">NBQP</a></li>
                    <li><a href="project-planning-and-implementation-division{{ route('frontend.history') }}">PPID</a></li>
                    <li><a href="project-analysis-and-documentation-division{{ route('frontend.history') }}">PADD</a></li>
                    <li><a href="https://zed.org.in/" target="_blank" rel="noreferrer noopener">ZED</a></li>
                    <li><a href="training-and-capacity-building{{ route('frontend.history') }}" target="_blank" rel="noreferrer noopener">TCB</a></li>
                    <li><a href="https://equest.co.in/" target="_blank" rel="noreferrer noopener">EQUEST</a></li>
                    <li><a href="racb{{ route('frontend.history') }}" target="_blank" rel="noreferrer noopener">RACB</a></li>
                </ul>
            </div>
